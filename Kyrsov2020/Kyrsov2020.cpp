...
// Kyrsov2020.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKyrsov2020App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKyrsov2020App

CKyrsov2020App::CKyrsov2020App()
{
...
// Единственный объект CKyrsov2020App

CKyrsov2020App theApp;


// Инициализация CKyrsov2020App

BOOL CKyrsov2020App::InitInstance()
{
